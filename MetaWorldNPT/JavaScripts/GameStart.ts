...
import Gtk, { createProvider, GtkTypes, RandomGenerator, RevisedInterval } from "./util/GToolkit";
...
function provider() {
    ...
    let retSingle = new Worker().handler(10); // [10,10]

    // console.log(workers.handler(10)); // ERROR
