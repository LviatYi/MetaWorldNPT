...
//         let btn = new Avatar();
//
//         btn._option = Avatar.defaultOption(option);
//         btn.initRoot();
//         btn._btn = mw.Avatar.newObject(btn.root, "btn");
...
//             Avatar.IMG_BTN_BOX_MARGIN.left,
//             Avatar.IMG_BTN_BOX_MARGIN.top,
//             Avatar.IMG_BTN_BOX_MARGIN.right,
//             Avatar.IMG_BTN_BOX_MARGIN.bottom,
//         );
...
//
//         const realBtnSize = {
//             x: contentX - Avatar.IMG_BTN_PRACTICAL_MARGIN.left - Avatar.IMG_BTN_PRACTICAL_MARGIN.right,
//             y: contentY - Avatar.IMG_BTN_PRACTICAL_MARGIN.top - Avatar.IMG_BTN_PRACTICAL_MARGIN.bottom,
//         };
//
//         const txtSize = {
//             x: realBtnSize.x - 2 * (Avatar.IMG_BTN_BOX_MARGIN.left + Avatar.IMG_BTN_BOX_MARGIN.right),
//             y: contentY,
//         };
//
//         Gtk.setUiPosition(this._txtLabel,
//             pl + 2 * Avatar.IMG_BTN_BOX_MARGIN.left,
//             pt);
//         Gtk.setUiSize(this._txtLabel,
//             txtSize.x,
//             txtSize.y);
//         Gtk.setUiPosition(this._cnvClickAnim,
//             pl + Avatar.IMG_BTN_PRACTICAL_MARGIN.left,
//             pt + Avatar.IMG_BTN_PRACTICAL_MARGIN.top,
//         );
...
// }
//
// export type AvatarVariant = "contained" | "outlined";
//
